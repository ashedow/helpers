...
![mythical structure of the kernel's random number generator](./structure-new-dev-urandom1.png)
...
![actual structure of the kernel's random number generator before Linux 4.8](./structure-new-dev-urandom2.png)
...
![actual structure of the kernel's random number generator from Linux 4.8 onward](./structure-new-dev-urandom3.png)
...
https://www.2uo.de/myths-about-urandom/ by Thomas Hühn
